        ...
        <div className="px-6 pb-7 pt-6">
          ...
          <div className="text-center">
            ...
            <p className="mt-3 text-left text-sm leading-6 text-gray-600 font-winthorpe">
              Réservez directement sur notre site et profitez {"d'une"}{" "}
              expérience plus personnelle avec des avantages exclusifs.
            </p>
          </div>
          ...
          <ul className="mt-6 space-y-2 text-sm text-gray-700 font-winthorpe">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong className="font-medium">Départ tardif</strong>
                <br />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong className="font-medium">Paiement sécurisé</strong>
                <br />
                Réservez en toute confiance grâce à notre système de réservation
                sécurisé.
              </span>
            </li>
          </ul>
          ...
          <p className="mt-3 text-center text-[10px] tracking-wide text-gray-400">
            Réservez directement auprès de Pure House Marrakech
          </p>
        </div>
      </div>
    </div>
